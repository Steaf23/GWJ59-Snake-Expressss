...
@onready var ITEM = preload("res://Level/item.tscn")
@onready var PICKUP = preload("res://Level/station.tscn")
@onready var DELIVERY = preload("res://Level/delivery_station.tscn")
@onready var SNAKE = preload("res://Level/Editor/editor_snake.tscn")
...
func _on_save_pressed() -> void:
	...
	print(ResourceSaver.save(packed_lvl, "res://LevelScenes/level_" + str(level) + ".tscn"))
	
	

func _on_load_pressed() -> void:
	var level: int = int($CanvasLayer/HBoxContainer/LineEdit.value)
	
	var lvl_scn = load("res://LevelScenes/level_" + str(level) + ".tscn")
	place_level(lvl_scn)
...
func place_level(scene: PackedScene) -> void:
	...
	if scene == null:
		print("Scene " + str(int($CanvasLayer/HBoxContainer/LineEdit.value)) + " does not exist!")
		return
